...
public class PaintUtil {
    ...
    private static final String DEFAULT_CORNER_COLOR = "#FF27A8E0";
    private static final String SEMI_TRANSPARENT = "#AA27A8E0";
    private static final String DEFAULT_BACKGROUND_COLOR_ID = "#30000000";
