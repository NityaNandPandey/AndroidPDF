...
public class CropImageView extends FrameLayout {
     ...
     *
     */
    public int getMarginSize() { return mImageMargin; }
    ...
    public void setCropRectPercentageMargins(RectF percentageMargins) {
        ...
        if (mCropOverlayView != null) {
            mCropOverlayView.setCropRectPercentageMargins(percentageMargins);
        }
    }
    ...
    public Bitmap getCroppedImage() {
        ...
        final float cropWindowX = Edge.LEFT.getCoordinate() - mImageMargin - displayedImageRect.left;
        final float cropWindowY = Edge.TOP.getCoordinate() - mImageMargin - displayedImageRect.top;
    ...
    public RectF getCropRectPercentageMargins() {
        return mCropOverlayView.getCropRectPercentageMargins();
    }

    /**
     * Gets whether or not a bitmap is currently avaiable
     *
     * @return true if a bitmap is currently available
     */
    ...
    private void init(Context context) {
        ...
        View marginHost = v.findViewById(R.id.bitmap_margin);
        RelativeLayout.LayoutParams lps = (RelativeLayout.LayoutParams)marginHost.getLayoutParams();
        mImageMargin = lps.leftMargin; // all margins are the same
