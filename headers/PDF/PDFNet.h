...
public:
	...
	*/
	...
	enum CloudErrorCode
	 {
		STATUS_ERR,					///<Unexpected error. If the error persists go to http://www.pdftron.com/kb_cloud_error
	    ...
	    STATUS_SERVICE_DOWN,		///<Server is not responding. If the error persists go to http://www.pdftron.com/kb_cloud_error
	    STATUS_INVALID_OPERATION,	///<Unexpected internal server error. If the error persists go to http://www.pdftron.com/kb_cloud_error
	    STATUS_NUM					///<
	 };
	/**
	 ...
	 * - ToEpub			(chargeable)
	 *
	 * @param username Your API ID. You should receive this information 
	 ...
	 * @param password This information is provided together with 
